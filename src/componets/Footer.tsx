        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <a
                href="index.html"
                className="block text-center header-logo"
                style={{ padding: 0, margin: 0 }}
              >
                <img
                  src="./assets/images/logo/logod.png"
                  className=""
                  width="200"
                  alt=""
                />
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7 mt-10">
                Unveil the hidden trends and biases in customer feedback,
                driving your business forward with tailored insights.{" "}
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">Links</h4>
              <ul>
                <li>
                  <a
                    onClick={() => navigator('/privacy')}
              ...
              <form action="#" className="" style={{ margin: "30px 0 0 0" }}>
                <div className="mt-6 flex max-w-md gap-x-4">
                  <input
                    ...
                    id="email"
                    required
                    className="min-w-0 flex-auto rounded-md bg-dark text-white shadow-sm border"
