    ...
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <a href="index.html" className="block text-center header-logo" style={{padding: 0, margin: 0}}>
                <img src="./assets/images/logo/logod.png" className="" width="200" alt="" />
               </a>
              <p className="mb-8 max-w-[270px] text-base text-gray-7 mt-10" >
                Twin Tech Recruit is reshaping the future of job seeking in digital twin technology. Our user-friendly platform offers personalised job suggestions and a novel virtual interview experience, helping you land the right role with ease and confidence.               </p>
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12 text-white">
           <div>
            <h1>Subscribe To our Newsletter</h1>
            <form action="#" className="" style={{margin: '30px 0 0 0'}}>
              <div className="mt-6 flex max-w-md gap-x-4">
                <input type="email" id="email" required className="min-w-0 flex-auto rounded-md bg-dark text-white shadow-sm border" placeholder="your email address" style={{padding: '10px', marginRight: '5px', borderColor: 'grey'}}/>
                <button className="flex-none rounded-md bg-primary text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500" style={{padding: '5px'}}>subscribe</button>
              </div>
          </form>
           </div>
          </div>
        ...
        <div className="container">
          <div className="-mx-4 flex justify-center items-center text-white">
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <p>&copy; All rights reserved 2024 | Developed by <a href="https://luqmanshaban,com" target="_blank" >Ruel Ngatia</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <span className="absolute right-0 top-0 z-[-1]">
          <img src={faintGrid} alt='footer start'/>
          <svg
            width="102"
            height="102"
            viewBox="0 0 102 102"
