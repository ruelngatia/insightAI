...
import arrow from "../assets/svg/arrowGrid.svg";
import { TeamMemberInterface } from "../models/TeamMemberInterface";

export const TeamMemberCard: React.FC<TeamMemberInterface> = ({
  image,
  title,
  description,
}): JSX.Element => {
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 my-20 rounded-lg shadow-2 xl:w-1/4 ">
