...
export default function HeroSection() {
  ...
  >
    <div className="container">
      <div>
        <video autoPlay muted style={{objectFit: 'initial'}} loop className="w-full h-full absolute top-0 left-0">
          <source src={vd} type="video/mp4"/>
          Your browser does not support the video tag.
        </video>
      </div>
      <div className="absolute top-0 left-0 bg-dark bg-opacity-20  w-full h-full"></div>
      <div className="-mx-4 flex flex-wrap items-center relative" style={{zIndex: 1}}>
        <div className="w-full px-4">
          ...
          >
            ...
            >
            Transform Your Customer Feedback into Actionable Insights with InsightAI					
            </h1>
            <p
              className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
            >
            Unveil the hidden trends and biases in customer feedback, driving your business forward with tailored insights.				
          </p>
            <ul
