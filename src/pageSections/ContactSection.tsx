      ...
      <div className="container px-4">
        <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                <h2 className="max-w-[280px] text-[35px] font-semibold leading-[1.14] text-dark dark:text-white">
                  InsightAI Contact Centre: Reach Out for Expert Support
                </h2>
              </div>
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div
              className="wow fadeInUp my-20 rounded-lg bg-white px-8 py-10 shadow-testimonial dark:bg-dark-2 dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]"
              data-wow-delay=".2s
            "
            >
